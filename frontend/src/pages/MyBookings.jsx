...
const MyBookings = () => {
  ...
  return (
    <div className="relative px-6 lg:px-40 pt-30 md:pt-40 min-h-[80vh]">
      ...
      {bookings.map((item, index) => (
        <div
          key={index}
          className="flex flex-col md:flex-row justify-between bg-primary/8 border border-primary/20 rounded-lg mt-4 p-2 max-w-fit"
        >
          <div className="flex flex-col md:flex-row">
            ...
            <div className="flex flex-col p-4">
              ...
              <p className="text-gray-400 text-sm mt-auto">{new Date(item.show.showDateTime).toLocaleString()}</p>
            </div>
          </div>
